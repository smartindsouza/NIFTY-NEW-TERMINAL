...
export default function AiMarketRead({
  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed bottom-4 right-4 z-[90] px-3 py-2 rounded-full text-xs font-mono font-bold bg-indigo-500/90 text-white shadow-lg hover:bg-indigo-500"
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[90] w-[92vw] max-w-[340px] bg-popover border border-border rounded-lg shadow-xl p-3 text-xs font-mono flex flex-col gap-2">
