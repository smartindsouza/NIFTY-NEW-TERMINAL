  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed top-[calc(max(env(safe-area-inset-top),12px)+0.75rem)] md:top-3 right-3 z-[90] px-3 py-2 rounded-full text-xs font-mono font-bold bg-indigo-500/90 text-white shadow-lg hover:bg-indigo-500"
